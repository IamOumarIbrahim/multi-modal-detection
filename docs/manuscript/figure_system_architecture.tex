...
% 1. RGB video prompt (Text File Icon, placed at x = -4.6)
...
\node[above=3pt of grok_rgb, ttl, text=purple!80!black] (lbl_g1) {Video Generator LLM};
...
% 3. 16:9 RGB Videos for Grok (752x416 @ 24 FPS) & Gemini (1280x720 @ 24 FPS)
...
\node[box, fill=orange!10, draw=orange!80!black, thick, font=\fontsize{5.6pt}{6.6pt}\selectfont, text width=2.6cm, align=center, minimum height=1.15cm] (melo_th) at (10.0, 6.0) {
    \textbf{Melobytes 256-Level LUT}\\[2pt]
    {\scriptsize Pseudo-Thermal Color Transfer}\\[1pt]
    {\tiny Non-Radiometric Emulation}
};
\node[above=4pt of melo_th, ttl, text=orange!80!black] (lbl_melo) {Melo Thermal Stylizing};
\node[below=2pt of melo_th, font=\fontsize{5.3pt}{6.4pt}\selectfont\bfseries, text=black] (sub_melo) {\texttt{melo\_lut} Processing};
...
% 10. Annotated Frames (Square Clean Frames with Accurate Person Bounding Boxes)
\node[framebox] (annotated_frames) at (27.0, 6.0) {
    \begin{tabular}{@{}c@{\hspace{3pt}}c@{}}

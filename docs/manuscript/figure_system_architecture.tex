...
\node[draw=purple!70, fill=purple!6, rounded corners=4pt, thick, font=\fontsize{5.8pt}{7.0pt}\selectfont, text=black, inner ysep=4pt, inner xsep=10pt, align=center] (dataset_banner) at (13.5, 3.65) {
    ...
    Parent-Video Grouped Split (Nominal 60/20/20; Realized 44/22/24 Tiles) $|$ Co-Located Left and Right Tiles\\
...
\node[method] (m6) at (13.3, -4.6) {\textbf{M6: Learned GRU Baseline}\\[1pt]Gated Recurrent Unit\\{\tiny (Single-Layer Recurrent Gating)}};
...
\draw[thick, draw=purple!80] (10.2, 1.9) -- (10.2, -4.6);
...
\draw[arrow, draw=purple!80] (10.2, -4.6) -- (m6.west);

% Collection Bus
\draw[thick, draw=teal!80] (16.4, 1.9) -- (16.4, -4.6);
...
\draw[arrow, draw=teal!80] (m6.east) -- (16.4, -4.6);
...
\node[kpi] (kpi_box) at (23.8, 0.75) {
    ...
    {\tiny Filter Buffering Delay Bound ($\leq$208~ms)}
};
...
\node[eval] (eval) at (23.8, -1.95) {
    ...
    Alert Latency (Time-to-Alarm)\\[1pt]

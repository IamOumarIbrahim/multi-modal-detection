...
\node[stepbox, text width=1.8cm, inner xsep=2pt] (v2f) at (22.8, 5.7) {
...
% Benchmark Corpus & Episodic Splitting Card (No MMSAR, generous padding above and below)
\node[draw=purple!70, fill=purple!6, rounded corners=4pt, thick, font=\fontsize{5.8pt}{7.0pt}\selectfont, text=black!85, inner ysep=4pt, inner xsep=10pt, align=center] (dataset_banner) at (13.0, 3.6) {
    \textbf{\textcolor{purple!90!black}{Benchmark Corpus and Sequence Partitioning [TBD]}}\\[2pt]
...
\coordinate (split_bus) at (-2.4, 3.6);
...
\node[detector] (yolo_rgb) at (3.2, 0.6) {\textbf{RGB Detector}\\[1pt]YOLO11n\\{\scriptsize 640$\times$640, 2.6M, FP32}};
\node[detector] (yolo_tir) at (3.2, -2.0) {\textbf{Thermal Detector}\\[1pt]YOLO11n\\{\scriptsize 640$\times$640, 2.6M, FP32}};
